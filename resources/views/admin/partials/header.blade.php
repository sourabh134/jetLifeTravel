...
<div class="wrapper">
    ...
    <div class="sidebar-wrapper" data-simplebar="true">
        <div class="sidebar-header">
            ...
            {{-- <div>
                    <h4 class="logo-text">Jet Admin</h4>
                </div> --}}
        ...
        <ul class="metismenu" id="menu">
            ...
            <li>
                ...
                <ul>
                    <li> <a href="{{ url('/flightbooking') }}"><i class='bx bx-radio-circle'></i>Flight</a>
                    </li>
                    <li> <a href="app-chat-box.html"><i class='bx bx-radio-circle'></i>Hotel</a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li> <a href="ecommerce-products-details.html"><i class='bx bx-radio-circle'></i>Corporate
                            Users</a>
                    </li>
        ...
        <div class="topbar d-flex align-items-center">
            <nav class="navbar navbar-expand gap-3">
                ...
                <div class="top-menu ms-auto">
                    <ul class="navbar-nav align-items-center gap-1" style="display: none">
