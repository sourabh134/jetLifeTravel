                                                ...
                                                <form action="#!">
                                                    <div class="row">
                                                        <div class="col-lg-3  col-md-6 col-sm-12 col-12">
                                                            <div class="flight_Search_boxed">
                                                                <p>From</p>
                                                                <input type="text" class="formplace" id="roundTripFromPlace" value="" placeholder="Leaving from">
                                                                <span id="roundTripAirportNameFrom">Leaving from...</span>
                                                                <div class="plan_icon_posation">
                                                                    <i class="fas fa-plane-departure"></i>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-3  col-md-6 col-sm-12 col-12">
                                                            <div class="flight_Search_boxed">
                                                                <p>To</p>
                                                                <input type="text" class="toplace" id="roundTripToPlace" value="" placeholder="Going to">
                                                                <span id="roundTripAirportNameTo">Going to... </span>
                                                                <div class="plan_icon_posation">
                                                                    <i class="fas fa-plane-arrival"></i>
                                                                </div>
                                                                <div class="range_plan">
                                                    ...
                                                    <div class="top_form_search_button">
                                                        <button class="btn btn_theme btn_md round_trip_flight_click">Search</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        const roundTripFromPlace = $('#roundTripFromPlace');
        ...
        roundTripFromPlace.on('input', function() {
            const query = roundTripFromPlace.val().trim();
            const roundTripAirportNameFrom = $('#roundTripAirportNameFrom');
            $searchList.empty();
                    ...
                    success: function(data) {
                        ...
                        if (Array.isArray(data)) {
                            data.forEach(item => {
                                ...
                                $div.on('click', function() {
                                    roundTripFromPlace.val(displayText);
                                    $searchList.empty();
                                });
                                ...
                                // const airportDetails = `${item.AirportCode} - ${item.AirportName}`;

                                // const displayText = `${cityCountry} (${airportDetails})`;

                                // const $div = $('<div class="search-item"></div>').text(displayText);

                                // $div.on('click', function() {
                                //     // Set City and Country in input field
                                //     roundTripFromPlace.val(cityCountry);

                                //     // Set Airport details in span
                                //     $('#roundTripAirportNameFrom').text(airportDetails);
...
<script>
    $(document).ready(function() {
        ...
        const roundTripToPlace = $('#roundTripToPlace');
        ...
        roundTripToPlace.on('input', function() {
            const query = roundTripToPlace.val().trim();
            $searchList.empty();
            const roundTripAirportNameTo = $('#roundTripAirportNameTo');
                    ...
                    success: function(data) {
                        ...
                        if (Array.isArray(data)) {
                            data.forEach(item => {
                                ...
                                $div.on('click', function() {
                                    roundTripToPlace.val(displayText);
                                    $searchList.empty();
                                });
                                ...
                                // $div.on('click', function() {
                                //     // Set City and Country in input field
                                //     roundTripToPlace.val(cityCountry);

                                //     // Set Airport details in span
                                //     $('#roundTripAirportNameTo').text(airportDetails);
...
<script>
    ...
    $('.round_trip_flight_click').click(function(e) {
        e.preventDefault();
        // Get input values
        const fromInput = $('#roundTripFromPlace').val().trim();
        const match = fromInput.match(/\((\w{3})\s-\s/);
        const fromairportCode = match[1]; // "DEL"

        const toInput = $('#roundTripToPlace').val().trim();
        const matcht = toInput.match(/\((\w{3})\s-\s/);
        const toairportCode = matcht[1]; // "DEL"
        const departureDate = $('#startDate').val().trim(); // expected format: DD/MM/YYYY
        const returnDate = $('#endDate').val().trim(); // expected format: DD/MM/YYYY
        const cabinClass = $('.changecname').text().trim().toLowerCase();
        // Get passenger counts
        const adults = parseInt($('#roundTripPcount').text()) || 1;
        const children = parseInt($('#roundTripCcount').text()) || 0;
        const infants = parseInt($('#roundTripIncount').text()) || 0;
        const passengerString = `children:${children > 0 ? `${children}` : '0'},adults:${adults},infantinlap:${infants > 0 ? `${infants}` : '0'}`;
        // Final URL
        const finalURL = `{{url('/Round-Trip-Flights-Search')}}?flight-type=on&mode=search&trip=roundtrip` +
            `&leg1=from:${encodeURIComponent(fromairportCode)},to:${encodeURIComponent(toairportCode)},departure:${departureDate},fromType:AIRPORT,toType:AIRPORT` +
            `&leg2=from:${encodeURIComponent(toairportCode)},to:${encodeURIComponent(fromairportCode)},departure:${returnDate},fromType:AIRPORT,toType:AIRPORT` +
            `&options=cabinclass:${cabinClass}` +
            `&fromDate=${departureDate}` +
            `&toDate=${returnDate}` +
            `&d1=${departureDate}` +
